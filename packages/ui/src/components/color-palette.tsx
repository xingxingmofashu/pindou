...
interface ColorPaletteProps {
  ...
  /**
   * All brands for the switcher. When empty/single, the switcher is hidden and
   * the active brand's name is shown instead.
   */
  brands: Palette[]
...
/**
 * Scrollable colour palette sidebar panel — fully controlled (the host owns
 * palette state and passes the catalog + active brand as props). Shared by the
 * web and desktop editors; the web landing editor wraps it with a store bridge
 * and catalog fetch, while read-only views pass a single pinned palette.
 */
